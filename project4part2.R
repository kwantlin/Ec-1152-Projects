...
setwd(dir = "/Users/kwantlin/My Documents/Harvard 2018-2019/Econ 1152/Project 4")
...
forest_hat <- randomForest(reformulate(vars, "kfr_pooled_p25"), ntree=1000,mtry=11, maxnodes=100,importance=TRUE, do.trace=25,data=proj4[proj4$training==1,], na.action=na.exclude) 
